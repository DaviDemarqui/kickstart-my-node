  ...
  return (
    <main className="flex min-h-screen items-center justify-between">
      <div className="max-md:m-0 m-20 flex">
        <div className="w-1/2 bg-white p-5 lg:pr-28 h-screen border border-black">
          ...
          <div className="block">
            <select className="border w-full border-black mb-[3px] text-black bg-transparent py-2 px-3 outline-none">
              <option defaultValue="" selected disabled>Select an license</option>
              <option defaultValue="">MIT</option>
              <option defaultValue="">GPD</option>
        ...
        <div className="w-1/2 bg-black overflow-y-scroll border border-black p-5  h-screen">
          <DependencySearch />
        </div>
      </div>
    </main>
